2024 Program Year Data Files

The file geography.csv file has the BLS geography
areas and codes.

The file ONet_Occs.csv contains occupational information, including
the Job Zone and the DOL Education and Training Code.

The file XWalk_Plus.csv contains records that match the O*Net occupations
